puts "Add cryptos:"
Crypto.create([
  { name: 'Bitcoin', symbol: 'btc', status: 'inactive', url: 'https://bitcoin.org/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/1/', stake: 0, block_reward: 0, logo_url: '/assets/images/logos/bitcoin.jpg' },
  { name: 'Dash', symbol: 'dash', description: 'Dash markets itself as the digital cash of crypto currency, providing users, merchants, and businesses a faster and cheaper online payment platform than competing blockchains. The Dash protocol features instant transaction confirmations, anonymity equal to physical cash, incentivized full nodes, and an DAO governance model to handle disputes.', url: 'https://www.dash.org/', explorer_url: 'https://explorer.dash.org/address/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/131/', stake: 1000, block_reward: 1.80, logo_url: '/assets/images/logos/dash.jpg' },
  { name: 'ZCoin', symbol: 'xzc', description: 'Zcoin is the first full implementation of the Zerocoin Protocol, which allows users to have complete privacy via Zero-Knowledge cryptographic proofs. It is worth noting that Zcoin is unrelated to other cryptocurrencies utilizing the Zerocash Protocol. Although Zerocash is a development from Zerocoin, their respective implementations are not simple forks of each other, but rely on different cryptographic assumptions with various tradeoffs.', url: 'https://zcoin.io/', explorer_url: 'https://explorer.zcoin.io/address/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/1414/', stake: 1000, block_reward: 15.0, logo_url: '/assets/images/logos/zcoin.jpg' },
  { name: 'Polis', symbol: 'polis', description: 'Polis is a cryptocurrency for communities. People thrive when they can connect and trade freely. Polis uses advanced decentralized blockchain technology to solve major problems for our global community.', url: 'https://polispay.org/', explorer_url: 'https://explorer.polispay.org/address/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2359/', stake: 1000, block_reward: 14.4, logo_url: '/assets/images/logos/polis.jpg' },
  { name: 'PIVX', symbol: 'pivx', status: 'active', description: 'PIVX is  a form of digital online money using blockchain technology that can be easily transferred all around the world in a blink of an eye with nearly non-existent transaction fees with market leading security & privacy.', url: 'https://pivx.org/', explorer_url: 'https://chainz.cryptoid.info/pivx/address.dws?', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/1169/', stake: 10000, block_reward: 2.25, logo_url: '/assets/images/logos/pivx.jpg' },
  { name: 'Stipend', symbol: 'spd', status: 'inactive', url: 'https://stipend.me/', explorer_url: 'http://explorer.stipend.me/address/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2616/', stake: 5000, block_reward: 12.0, logo_url: '/assets/images/logos/stipend.jpg' },
  { name: 'GoByte', symbol: 'gbx', description: 'GoByte (GBX) is a cryptocurrency based on Dash aimed at vendors to provide monetary services . GoByte uses masternodes to provide near-instant and secure payments as well as anonymous transactions.', status: 'active', url: 'https://www.gobyte.network/', explorer_url: 'https://explorer.gobyte.network/address/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2200/', stake: 1000, block_reward: 10.5, logo_url: '/assets/images/logos/gobyte.jpg' },
  { name: 'Blocknet', symbol: 'block', description: 'Blocknet empowers the passionate communities behind every coin with atomic swaps on a truly decentralized cross-blockchain platform. Blocknet serves as a connector between blockchains, markets, and communities.', status: 'active', url: 'https://www.blocknet.co/', explorer_url: 'https://chainz.cryptoid.info/block/address.dws?', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/707/', stake: 5000, block_reward: 0.7, logo_url: '/assets/images/logos/blocknet.png' },
  { name: 'Phore', symbol: 'phr', description: 'Phore Blockchain enables the transfer of value across an accessible, standardized ecosystem that is secure, flexible and scalable.', status: 'active', url: 'https://phore.io', explorer_url: 'https://chainz.cryptoid.info/phr/address.dws?', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2158/', stake: 10000, block_reward: 1.8, logo_url: '/assets/images/logos/phore.png' },
])
