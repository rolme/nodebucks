...
Crypto.create([
  ...
  { name: 'Phore', symbol: 'phr', description: 'Phore Blockchain enables the transfer of value across an accessible, standardized ecosystem that is secure, flexible and scalable.', status: 'active', url: 'https://phore.io', explorer_url: 'https://chainz.cryptoid.info/phr/address.dws?', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2158/', stake: 1000, block_reward: 1.8, logo_url: '/assets/images/logos/phore.png' },
])
