...
Crypto.create([
  ...
  { name: 'Stipend', symbol: 'spd', status: 'inactive', url: 'https://stipend.me/', explorer_url: 'http://explorer.stipend.me/address/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2616/', stake: 5000, daily_reward: 10.3989, block_reward: 12.0, logo_url: '/assets/images/logos/stipend.jpg' },
  { name: 'GoByte', symbol: 'gbx', description: 'GoByte (GBX) is a cryptocurrency based on Dash aimed at vendors to provide monetary services . GoByte uses masternodes to provide near-instant and secure payments as well as anonymous transactions.', status: 'active', url: 'https://www.gobyte.network/', explorer_url: 'https://explorer.gobyte.network/address/', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2200/', stake: 1000, daily_reward: 2.1960, block_reward: 10.5, logo_url: '/assets/images/logos/gobyte.jpg' },
  ...
  { name: 'Phore', symbol: 'phr', description: 'Phore Blockchain enables the transfer of value across an accessible, standardized ecosystem that is secure, flexible and scalable.', status: 'active', url: 'https://phore.io', explorer_url: 'https://chainz.cryptoid.info/phr/address.dws?', ticker_url: 'https://api.coinmarketcap.com/v2/ticker/2158/', stake: 10000, daily_reward: 10.4415, block_reward: 30.8, logo_url: '/assets/images/logos/phore.png' },
])
